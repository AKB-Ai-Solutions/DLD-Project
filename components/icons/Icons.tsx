...
export const SunIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-6.364-.386l1.591-1.591M3 12h2.25m.386-6.364l1.591 1.591M12 12a2.25 2.25 0 00-2.25 2.25c0 1.242 1.008 2.25 2.25 2.25s2.25-1.008 2.25-2.25a2.25 2.25 0 00-2.25-2.25z" />
  </Icon>
);
...
export const ChipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9h-1.5V7.5h1.5m0 9h-1.5v-1.5h1.5m15-7.5h1.5V7.5h-1.5m0 9h1.5v-1.5h-1.5M9 3.75v-1.5H7.5v1.5m9 0v-1.5h-1.5v1.5m-7.5 15v1.5H7.5v-1.5m9 0v1.5h-1.5v-1.5" />
    </Icon>
);
...
export const ResetIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.691V5.25m0 0H9.345m0 0l3.181 3.183a8.25 8.25 0 01-11.667 0l3.181-3.183" />
    </Icon>
);
...
export const FeedbackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props} fill="currentColor" stroke="none">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m3.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.542-.383l-3.352 1.341a.375.375 0 01-.482-.482l1.341-3.352a9.76 9.76 0 01-.383-2.542c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
    </Icon>
);
